...
module Rack
  class ReverseProxy
    ...
    def call(env)
      ...
      session.start { |http|
        ...
        body = matcher.post_process_body(body,headers,rackreq)
  ...
  class ReverseProxyMatcher
    ...
    def post_process_body(body,headers=nil,rackreq=nil)
      @body_modifier.nil? ? body : @body_modifier.call(body,headers,rackreq)
    end
